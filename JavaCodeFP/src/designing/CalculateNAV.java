...
public class CalculateNAV {
	...
	public BigDecimal computeStockWorth(
		...
		return priceFinder.apply(ticker).multiply(BigDecimal.
				valueOf(shares));
	}
	
	private Function<String, BigDecimal> priceFinder;
	
	public CalculateNAV(final Function<String,
			BigDecimal> aPriceFinder) {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("100 shares of "
				+ "Google worth: $%.2f",
